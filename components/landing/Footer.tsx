export default function Footer() {
  return (
    <footer className="relative py-16 px-4 border-t border-white/10 bg-black/50 backdrop-blur-xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-9 h-9 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-purple-500/50 rounded-lg flex items-center justify-center transition-all">
          ...
          {/* Product Links */}
          <div>
            <h3 className="font-bold text-sm uppercase tracking-wider mb-4 text-purple-300">Product</h3>
          ...
          {/* Company Links */}
          <div>
            <h3 className="font-bold text-sm uppercase tracking-wider mb-4 text-purple-300">Company</h3>
            <ul className="space-y-3">
          ...
          {/* Legal Links */}
          <div>
            <h3 className="font-bold text-sm uppercase tracking-wider mb-4 text-purple-300">Legal</h3>
            <ul className="space-y-3">
